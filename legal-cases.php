<?php require_once 'components/sidebar.php';?>
      <div class="bottom animate-fadeUp">
        <div class="all-content">
          <div class="search-file-container">
            ...
            <div class="button-container">
              ...
              <a href="add-case.php" class="task-file-btn" id="task-file-btn"
                ><i class="fa-solid fa-plus"></i> &nbsp; Add Case</a
              >
        ...
        <div class="cases" id="cases">
          <h2 style="margin-top: 40px; text-align: center; font-weight: 900;">NO LEGAL CASE FOUND</h2>
        </div>
      </div>
    </section>
      ...
      document.addEventListener('DOMContentLoaded', ()=>{
        ...
        searchBtn.addEventListener('click', ()=>{
          ...
          if(searchValue.length > 0){
            $.ajax({
              url: "logic/search-legal-cases.php",
              method: "GET",
              data: {
                location: location,
                search: searchValue,
        ...
        fetchCases(); // Fetch cases on page load
        ...
        function populateCases(cases){
          if(cases.length > 0){
            ...
            cases.forEach((singleCase) =>{
              ...
              caseDiv.href = 'case.php?id=' + singleCase.case.id;
